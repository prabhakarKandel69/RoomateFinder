        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        match = Match.objects.get(user_1=request_user,user_2=requesting_user)
                        match.matched = True
                        return Response({"error": "Match req accepted(other user had sent request)."}, status=status.HTTP_200_OK)
                    except Match.DoesNotExist:
