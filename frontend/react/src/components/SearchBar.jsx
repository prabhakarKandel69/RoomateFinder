  ...
  return (
    ...
    >
      ...
      <div className="flex items-center flex-grow bg-[#E7F8FD] rounded-lg px-3 py-2">
        <span className="text-[#243B55] text-lg mr-2"> <img src="../img/location.svg" alt="location" className="h-[24px] w-[24px] mr-1" /></span>
        <input
          type="text"
      ...
      <div className="relative bg-[#E7F8FD] px-3 py-2 rounded-lg flex items-center">
        <span className="text-[#243B55] text-lg mr-2"><img src="../img/house.svg" alt="location" className="h-[24px] w-[24px] mr-1" /></span>
        <select
          className="bg-primary focus:outline-none text-secondary text-sm font-bold"
          defaultValue="have room"
        >
          <option value="have room" className="text-secondary font-bold">Looking for Roommate with Room</option>
          <option value="no room" className="text-secondary font-bold">Looking for Roommate without Room</option>
        </select>
